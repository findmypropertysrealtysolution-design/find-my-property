...
import { MapPin, Bed, Bath, Square, ArrowLeft, Phone, User, Heart, Play, Plus, Calendar, Send, Loader2 } from "lucide-react";
...
const PropertyDetail = () => {
  ...
  const loginHref = `/login?from=${encodeURIComponent(pathname || `/property/${id}`)}`;
                ...
                <div className="border-t border-border pt-4 flex flex-col gap-2">
                  {canEnquireAsTenant ? (
                    <>
                      ...
                      >
                        <Send className="w-4 h-4" /> Send enquiry to agent
                      </Button>
                      <Dialog open={enquiryOpen} onOpenChange={setEnquiryOpen}>
                        <DialogContent className="sm:max-w-md">
                          ...
                          <div className="space-y-2 py-2">
                            <Label htmlFor="enquiry-msg">Message (optional)</Label>
                            <Textarea
                              id="enquiry-msg"
                          ...
                          <DialogFooter>
                            <Button variant="outline" type="button" onClick={() => setEnquiryOpen(false)}>
                              Cancel
                            </Button>
                            <Button
                              type="button"
                    ...
                    <Button className="w-full gap-2" size="lg" asChild>
                      <Link href={loginHref}>
                        <Phone className="w-4 h-4" /> Sign in to send enquiry
                      </Link>
                    </Button>
                  )}
                </div>
