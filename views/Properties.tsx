...
import { FurnishingStatus } from "@/components/PropertyCard";
    ...
    <div className={isAuthenticated ? "pt-6 pb-12" : "pt-24 pb-20"}>
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            {/* Sidebar Filters - card-based pill design */}
            <aside
              className={`${
                showFilters ? "block" : "hidden"
              } md:!block w-full md:w-80 shrink-0 order-2 md:order-1`}
            >
              <div className="bg-muted/30 rounded-2xl border border-border overflow-hidden sticky top-24 flex flex-col max-h-[calc(100vh-7rem)]">
                {/* Header: Filters */}
                <div className="flex items-center justify-between px-5 py-4 border-b border-border bg-background/80 shrink-0">
                ...
                {/* Clear Filters - full width at bottom */}
                <div className="p-4 border-t border-border bg-background/80 shrink-0">
                  <Button
                    variant="outline"
                    className="w-full rounded-xl bg-muted/50 border-border text-foreground hover:bg-muted"
            ...
            {/* Results - always visible with List/Map toggle */}
